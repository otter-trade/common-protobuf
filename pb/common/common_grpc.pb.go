...
func (c *commonClient) GetUserApiKeyByStrategyId(ctx context.Context, in *GetUserApiKeyByStrategyIdReq, opts ...grpc.CallOption) (*GetUserApiKeyByStrategyIdResp, error) {
	out := new(GetUserApiKeyByStrategyIdResp)
	err := c.cc.Invoke(ctx, "/pb.Common/GetUserApiKeyByStrategyId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommonServer) GetUserApiKeyByStrategyId(context.Context, *GetUserApiKeyByStrategyIdReq) (*GetUserApiKeyByStrategyIdResp, error) {
...
func _Common_GetUserApiKeyByStrategyId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserApiKeyByStrategyIdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommonServer).GetUserApiKeyByStrategyId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Common/GetUserApiKeyByStrategyId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).GetUserApiKeyByStrategyId(ctx, req.(*GetUserApiKeyByStrategyIdReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Common_GetUserApiKeyByStrategyId_Handler,
		},
	},
