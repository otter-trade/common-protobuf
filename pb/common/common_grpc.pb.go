...
func (c *commonClient) TestApi(ctx context.Context, in *TestApiReq, opts ...grpc.CallOption) (*TestApiResp, error) {
	out := new(TestApiResp)
	err := c.cc.Invoke(ctx, "/pb.Common/TestApi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommonServer interface {
	//* 根据策略Id获取用户以及api key *
	TestApi(context.Context, *TestApiReq) (*TestApiResp, error)
...
func (UnimplementedCommonServer) TestApi(context.Context, *TestApiReq) (*TestApiResp, error) {
...
func _Common_TestApi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestApiReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommonServer).TestApi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Common/TestApi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).TestApi(ctx, req.(*TestApiReq))
	}
...
var Common_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TestApi",
			Handler:    _Common_TestApi_Handler,
		},
	},
