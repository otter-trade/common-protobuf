...
func (x *TestApiResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestApiResp) ProtoMessage() {}

func (x *TestApiResp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_common_common_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestApiResp.ProtoReflect.Descriptor instead.
func (*TestApiResp) Descriptor() ([]byte, []int) {
...
var file_proto_common_common_proto_rawDesc = []byte{
	...
	0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x0c, 0x0a, 0x0a, 0x54, 0x65, 0x73, 0x74,
	0x41, 0x70, 0x69, 0x52, 0x65, 0x71, 0x22, 0x0d, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74, 0x41, 0x70,
	0x69, 0x52, 0x65, 0x73, 0x70, 0x32, 0x34, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x12,
	0x2a, 0x0a, 0x07, 0x54, 0x65, 0x73, 0x74, 0x41, 0x70, 0x69, 0x12, 0x0e, 0x2e, 0x70, 0x62, 0x2e,
	0x54, 0x65, 0x73, 0x74, 0x41, 0x70, 0x69, 0x52, 0x65, 0x71, 0x1a, 0x0f, 0x2e, 0x70, 0x62, 0x2e,
	0x54, 0x65, 0x73, 0x74, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x70, 0x42, 0x0d, 0x5a, 0x0b, 0x2e,
...
var file_proto_common_common_proto_goTypes = []interface{}{
	...
	(*TestApiReq)(nil),  // 1: pb.TestApiReq
	(*TestApiResp)(nil), // 2: pb.TestApiResp
}
var file_proto_common_common_proto_depIdxs = []int32{
	1, // 0: pb.Common.TestApi:input_type -> pb.TestApiReq
	2, // 1: pb.Common.TestApi:output_type -> pb.TestApiResp
